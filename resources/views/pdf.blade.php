                                ...
                                <div class="container m-auto px-6">
                                    ...
                                    <div class="lg:flex justify-between items-center">
                                        <div class="lg:w-6/12 lg:p-0 p-7">
                                            <h1 class="sm:text-5xl text-4xl text-black font-medium leading-tight mb-5 capitalize">M Sylva </h1>

                                            <p class="text-xl text-red-400">
                                                votre inscription a l'evenement est reussie. <br /> Gardez ce document en lieu sûr , il pourrait vous être utile en cas de besoin.
                                            </p>
                                        ...
                                        <div class="lg:w-4/12 rounded-full scale-100 rounded-lg ">
                                            ...
                                            <img class="" alt="sahil logo" width="350" height="350" src="" />
